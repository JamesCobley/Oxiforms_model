...
P_oxidation_Cys215 = 0.0150
P_oxidation_other = 0.00311
...
blob = bucket.blob("proteoform_route_map_POX_1uM.csv")
...
blob = bucket.blob("PTP1B_proteoform_final_distribution_with_counts_POX_1uM.xlsx")
